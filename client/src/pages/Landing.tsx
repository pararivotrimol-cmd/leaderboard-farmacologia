...
export default function Landing() {
  ...
  const timeline = [
    ...
    { week: "Semana 2", title: "Farmacocinética II", detail: "Distribuição, metabolismo, excreção. Biotransformação hepática, citocromo P450. TBL 1.", icon: <Pill size={18} /> },
    { week: "Semana 3", title: "Farmacodinâmica", detail: "Receptores, agonistas, antagonistas, dose-resposta, potência e eficácia. Caso Clínico 1.", icon: <Brain size={18} /> },
    { week: "Semana 4", title: "Boas Práticas Prescritivas", detail: "Prescrição racional, interações medicamentosas, farmacovigilância. TBL 2.", icon: <Brain size={18} /> },
    ...
    { week: "Semana 12", title: "Anestésicos Locais", detail: "Mecanismo de ação, classificação, uso clínico em procedimentos. Caso Clínico 4.", icon: <Pill size={18} /> },
    { week: "Semana 13", title: "Anti-histamínicos", detail: "Receptores H1 e H2, anti-histamínicos de 1ª e 2ª geração, uso clínico em alergias.", icon: <Pill size={18} /> },
    { week: "Semana 14", title: "JIGSAW 2 — Seminários", detail: "Canabinoides, Choque Cardiogênico, Farmacologia dos Emagrecedores.", icon: <Target size={18} />, highlight: true },
    { week: "Semana 15", title: "Prova P2", detail: "Avaliação individual (P2): conteúdo de adrenérgicos até anti-histamínicos.", icon: <Zap size={18} />, highlight: true },
    { week: "Semana 16", title: "Segunda Chamada P2", detail: "Prova substitutiva para alunos que perderam P2 com justificativa.", icon: <Zap size={18} /> },
    { week: "Semana 17", title: "Prova Final + Premiação", detail: "Prova final para alunos em recuperação. Cerimônia de premiação das equipes campeãs.", icon: <Trophy size={18} />, highlight: true },
  ];
